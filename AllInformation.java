...
public class AllInformation {
     ...
     * Parameters ,it calls 3 lists (ArrayList Account), 
     * ArrayList RegisterGround, and ArrayList Account
     */
     ...
     * @param newUser is an object to call the constructor of Account class
     *  and add new one
     */
     ...
     * @param account is an object to call the constructor of Account class
     *  and add new one
     */
     ...
     * @throws Exception that return message if any user information is 
    ...
    public Account searchAccount(int index,String passWord) throws Exception {
        ...
        if(user==null) throw new Exception ("This Account not exist ,try again");
    ...
    public RegisterGround searchPlayGround (int index)throws Exception{
        ...
        else return playgroundInfo;
    
    }
    /**
     * userhaveGround is a function from type Account that takes int index 
     * as a parameter and store it 
     * @param index is a parameter that contain the index of the user's playground 
    ...
    public void showallGround(){
       ...
       for(RegisterGround It:playGround) {          
            System.out.println(counter+"-"+" GroundName: "+It.getGroundName()+" Place: "+It.getPlace()+" Price: "+It.getPrice()+" RentalTime: "+It.getRentalTime()+" Duration: "+It.getDuration());
            counter++;
        }
     ...
     * @param index is a parameter that contain the account index and to edit on it
     */
