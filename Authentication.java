...
public class Authentication {
    ...
    /**
     * validInformation is a void function that check the validation of user information
    ...
    public void validInformation() throws Exception{
        ...
        if(((mobilePhone.length()<10))||(mobilePhone.length()>10)||(!(email.contains("@gmail.com")) )) throw new Exception("The information not correct ,try again");
        
    }
    
    
    /**
     * setuserName is a void function that take a String userName as 
     * a parameter and store it
    ...
    /**
     * setpassword is a void function that take a String password as 
     * a parameter and store it
    ...
    /**
     * setmobilePhone is a void function that take a String mobilePhone as 
     * a parameter and store it
