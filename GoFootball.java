...
public class GoFootball {
    ...
    public static void main(String[] args) {
        ...
        int choiceNum1=0,accountId=1,choiceNum2=0,price,groundId=1,despoistMoney,choice3;
        String userName, password, phone,email;
   
        String groundName,place,size,rentalTime,duration;
        ...
        while(choiceNum1!=3){
            ...
            switch (choiceNum1) 
            {
                    ...
                    while(choiceNum2!=5){
                       ...
                       switch(choiceNum2){
                            ...
                            case 1:
                            {
                                ...
                                System.out.println("choose the playgroundNumber");
                ...
                case 2:{
                    ...
                    System.out.println("Success create new account ,your userId is"+' '+accountId);
                    accountId++;
                    break;
                }
                case 3:{
